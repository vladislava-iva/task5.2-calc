...
int main() {
    ...
    cout<< "\n1.1 ЛИНЕЙНАЯ: y = a*x + b"<<endl;
    cout << "\nиз условия dS/da=0, dS/db=0 получаем систему:\n";
    cout << "Sigma_xi^2 * a + Sigma_xi * b = Sigma_xi*yi\n";
    cout << "Sigma_xi * a + n * b = Sigma_yi\n\n";
    ...
    cout<<"\n1.3 ПОКАЗАТЕЛЬНАЯ: y = be * e^(a*x)"<<endl;
    ...
    cout<<"\n1.4 КВАДРАТИЧНАЯ: y = a*x^2 + b*x + c"<<endl;
    cout << "\nиз условия dS/da=0, dS/db=0, dS/dc=0 получаем систему 3x3:\n";
    cout << "Sigma_x^4*a + Sigma_x^3*b + Sigma_x^2*c = Sigma_x^2*yi\n";
    cout << "Sigma_x^3*a + Sigma_x^2*b + Sigma_x *c = Sigma_x*yi\n";
    cout << "Sigma_x^2*a + Sigma_x *b + n *c = Sigma_yi\n\n";
    cout << "подставляем:\n";
    ...
    cout<<"\n3. СРАВНЕНИЕ СУММАРНЫХ ПОГРЕШНОСТЕЙ"<<endl;
    string names[4] = {
        "линейная y = a*x + b",
        "степенная y = be*x^a",
        "показат-я y = be*e^(ax)",
        "квадратич. y = a*x^2+b*x+c"
    };
    int best = 0;
